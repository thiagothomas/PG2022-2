...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// CHAO
		glUniform4f(colorLoc, 1.0f, 0.502f, 0.0f, 1.0f); //enviando cor para variável uniform inputColor
		...
		// PORTA PINTADA
		glUniform4f(colorLoc, 0.4f, 0.2f, 0.0f, 1.0f); //enviando cor para variável uniform inputColor
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		...
		-0.1, 0.175, 0.0, // QUADRADO1 DA JANELA
		-0.1, 0.2, 0.0,
		-0.05, 0.2, 0.0,
		-0.05, 0.175, 0.0,

		-0.1, 0.2, 0.0, // QUADRADO2 DA JANELA
		-0.1, 0.225, 0.0,
		-0.05, 0.225, 0.0,
		-0.05, 0.2, 0.0,

		-0.05, 0.2, 0.0, // QUADRADO3 DA JANELA
		-0.05, 0.225, 0.0,
		-0.0, 0.225, 0.0,
		-0.0, 0.2, 0.0,

		-0.05, 0.175, 0.0, // QUADRADO4 DA JANELA
		-0.05, 0.2, 0.0,
		-0.0, 0.2, 0.0,
		-0.0, 0.175, 0.0,
